...
CREATE TABLE `terceirizado` (
  `idTerceirizado` int NOT NULL AUTO_INCREMENT,
  `cpfTerceirizado` varchar(14) NOT NULL,
  `nomeCompletoTerceirizado` varchar(60) NOT NULL,
  `empresaTerceirizado` varchar(20) NOT NULL,
  `areaAtuacaoTerceirizado` varchar(20) NOT NULL,
  PRIMARY KEY (`idTerceirizado`),
  UNIQUE KEY `idTerceirizado_UNIQUE` (`idTerceirizado`)
